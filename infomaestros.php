...
if (filter_input_array(INPUT_GET)) {
    if (!empty(filter_input(INPUT_GET, ("ID")))) {
        ...
        if ($ID === '') {
            ...
            $resultados = mysqli_query($conexion, "select * from usuario where md5(concat('" . CLAVE . "', ID))='" . $ID . "';");
...
<html lang="es">
    <head>
        ...
        <link href="css/estilos_info_1.css" rel="stylesheet">
